...
class LegTrackingViewState extends State<ArViewWidget> with WidgetsBindingObserver {
  ...
  LegTrackingViewState(Sample sample) {
    this.sample = sample;
...
class ArViewWidget extends StatefulWidget {
  ...
  @override
  LegTrackingViewState createState() => new LegTrackingViewState(sample);
}
